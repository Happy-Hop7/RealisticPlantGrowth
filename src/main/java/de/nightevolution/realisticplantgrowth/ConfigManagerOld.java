...
/**
 * ConfigManagerOld is a singleton class responsible for managing and handling the configuration
...
public class ConfigManagerOld {
    ...
    /**
     * Constructor for a new Singleton ConfigManagerOld instance, which creates, reads, and updates the config file.
     * Get an instance of ConfigManagerOld with ConfigManagerOld.get().
     * ConfigManagerOld uses BoostedYAML API to perform file operations.
     */
    private ConfigManagerOld() {

        configManagerOld = this;
    ...
    /**
     * Get a Singleton instance from ConfigManagerOld.
     * Creates a new instance if no instance already exists.
     *
     * @return ConfigManagerOld Singleton instance
     */
    protected static ConfigManagerOld get() {
        if (configManagerOld == null)
            new ConfigManagerOld();
